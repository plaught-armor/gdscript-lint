...
**Freed object ID reuse** ([#32383](https://github.com/godotengine/godot/issues/32383), C8) — stale ref may resolve to different object. Null after free; check validity AND type.
